...
const AreaMap = {
  areas: [
  {
    ...
    "x": 133.3,
    "y": 287.0,
    "lat": 19.801914548172775,
    "lon": 72.71801250353985,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 342.0,
      "avg": 385.6,
      "max": 433.0
  ...
  },
  {
    ...
    "x": 170.0,
    "y": 198.5,
    "lat": 19.80908616824791,
    "lon": 72.7216536391168,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 368.0,
  ...
  },
  {
    ...
    "x": 491.6,
    "y": 155.6,
    "lat": 19.812563458540883,
    "lon": 72.75358151195006,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 394.0,
  ...
  },
  {
    ...
    "x": 306.5,
    "y": 114.5,
    "lat": 19.81589544225729,
    "lon": 72.7352068015881,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 351.0,
  ...
  },
  {
    ...
    "x": 561.7,
    "y": 292.5,
    "lat": 19.801469152213787,
    "lon": 72.76053572746154,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 378.0,
  ...
  },
  {
    ...
    "x": 766.7,
    "y": 485.5,
    "lat": 19.785833745219637,
    "lon": 72.78088445327154,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 326.0,
  ...
  },
  {
    ...
    "x": 440.9,
    "y": 286.6,
    "lat": 19.80195244270844,
    "lon": 72.7485464436059,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 338.0,
  ...
  },
  {
    ...
    "x": 674.9,
    "y": 202.5,
    "lat": 19.808769122644843,
    "lon": 72.77177070724198,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 369.0,
  ...
  },
  {
    ...
    "x": 551.0,
    "y": 116.7,
    "lat": 19.815715905939314,
    "lon": 72.75947490083091,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 351.0,
  ...
  },
  {
    ...
    "x": 647.4,
    "y": 201.5,
    "lat": 19.808847634847986,
    "lon": 72.76904366881658,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 342.0,
  ...
  },
  {
    ...
    "x": 419.7,
    "y": 295.5,
    "lat": 19.801231932675993,
    "lon": 72.74644140485492,
    "samples": 10,
    "sources": "Borewell, Handpump, Tap, Open Well",
    "tds": {
      "min": 337.0,
      ...
      this.samples.forEach((s) => {
        ...
        pinsHtml += `
          <g class="map-pin cursor-pointer group" onclick="AreaMap.inspectSample('${s.id}')">
            ...
            <title>${s.id} - ${s.area} (${s.source})\nTDS: ${s.tds} mg/L, pH: ${s.ph}, Turb: ${s.turb} NTU, Temp: ${s.temp}°C\nGPS: ${s.lat.toFixed(6)}, ${s.lon.toFixed(6)}</title>
          </g>
        `;
      });
    }
  ...
  inspectSample(sampleId) {
    ...
    if (!s) return;
    const msg = `Sample ${s.id} in ${s.area} (${s.source} at ${s.lat.toFixed(6)}°N, ${s.lon.toFixed(6)}°E): TDS is ${s.tds} mg/L, pH is ${s.ph}, Turbidity is ${s.turb} NTU, Temperature is ${s.temp}°C, and Hardness is ${s.hard} mg/L.`;
